...
##### Create HF Token
# Changed in 2.6
# old: {"name":"hf_token","data":{"HF_TOKEN":""},"type":"hf"}
# new: {"name":"hf_token","data":{"hf":{"token":"$HF_TOKEN"}},"type":"hf"}
echo -e "\nCreating HF Token"
PAYLOAD=$(cat <<EOF
{"name":"hf_token","data":{"hf":{"token":"$HF_TOKEN"}},"type":"hf"}
EOF
)
