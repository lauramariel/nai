...
class calm_application_namebootResources(AhvVmResources):
    ...
    disks = [
        AhvVmDisk.Disk.Scsi.cloneFromImageService(
            "nkp-rocky-9.6-release-cis-1.33.5-20251108010758.qcow2", bootable=True
        )
    ]
    nics = [AhvVmNic.NormalNic.ingress("primary", cluster="DM3-POC139")]
...
class calm_application_nameboot(AhvVm):
    ...
    cluster = Ref.Cluster(name="DM3-POC139")
...
class Nutanix(Profile):
    ...
    MANAGEMENT_WORKSPACE_APPS = CalmVariable.Simple(
        "nkp-insights,nkp-insights-1.6.9",
...
class nkp216(Blueprint):
    """NKP v2.16.1 Management Cluster deployment

    [NKP Dashboard](@@{Admin.NKP_DASHBOARD_URL}@@)
